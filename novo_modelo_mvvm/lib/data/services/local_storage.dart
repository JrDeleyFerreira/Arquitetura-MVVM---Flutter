import 'package:novo_modelo_mvvm/data/exceptions/local_exceptions.dart';
...
class LocalStorage {
  AsyncResult<String> saveData(String key, String value) async {
    try {
      ...
      return Failure(LocalExceptions(e.toString(), s));
    }
  }
  ...
  AsyncResult<String> getData(String key) async {
    try {
      ...
      return value != null
          ? Success(value)
          : Failure(LocalExceptions('Data not found'));
    } catch (e, s) {
      return Failure(LocalExceptions(e.toString(), s));
    }
  }
